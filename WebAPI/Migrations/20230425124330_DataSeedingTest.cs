    ...
    public partial class DataSeedingTest : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                ...
                select 'Burgas',@UserID,getdate(),'Bulgaria'
                union
                select 'Varna',@UserID,getdate(),'Bulgaria'
                union
                select 'Sofia',@UserID,getdate(),'Bulgaria'
                union
                select 'Stara Zagora',@UserID,getdate(),'Bulgaria'
                union
                select 'Bucharest',@UserID,getdate(),'Romania'
